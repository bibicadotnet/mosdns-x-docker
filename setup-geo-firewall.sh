...
RATE_LIMIT_PER_SECOND=20  # connections per second per IP
RATE_LIMIT_BURST=50       # allow short bursts
...
ALLOWLIST_IPS=("217.15.166.168" "$PUBLIC_IP" "45.146.6.3" "43.153.194.59")
